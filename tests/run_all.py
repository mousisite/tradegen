...
SUITES = [
    ...
    ("test_quality.py",      True,  "Piotroski, Altman, Beneish and accruals against known values"),
    ...
    ("test_ops.py",          True,  "charts, scrubbed error reports, verified backups, usage access"),
